    ...
    <>
      ...
      <Breadcrumbs
        items={[
          ...
          { name: locale === "uk" ? "Накопичувачі" : "Storage", href: `/${locale}/components/storage/${storageType}` },
          { name: typeName, href: `/${locale}/components/storage/${storageType}` },
          { name: post.title, href: `/${locale}/components/storage/${storageType}/${slug}` },
        ]}
      />
